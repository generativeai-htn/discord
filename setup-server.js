 ...
 * ของวิทยาลัยเทคโนโลยีไฮเทค หนองไผ่ (HTN) โดยอัตโนมัติ ครอบคลุม: ข้อมูลเซิร์ฟเวอร์, ประกาศ,
 * รับสมัครเรียน, กิจกรรม, ทั่วไป, วิชาการ, แยกตามสาขา, เกม-กีฬา, ผ่อนคลาย, ช่วยเหลือ
 *
 * รายชื่อสาขาใน BRANCHES ด้านล่างอ้างอิงจากหลักสูตร ปวช./ปวส. ของวิทยาลัย
 * (สาขาที่เปิดสอนทั้งสองระดับถูกรวมเป็นหมวดเดียว)
 *
 * วิธีใช้:
...
// รายชื่อสาขาวิชา — แก้ไขได้ที่ branches.js (ใช้ร่วมกับ setup-roles.js)
...
const BASE_STRUCTURE = [
  ...
  {
    // เปิดสาธารณะ: บุคคลภายนอก/นักเรียนที่สนใจสมัครเข้าดูและถามได้
